 ...
 */
@TableName("kaishirenwu")
public class KaishirenwuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public KaishirenwuEntity() {
		
	}
	
	public KaishirenwuEntity(T t) {
		try {
	 ...
	 * 设置：开始编号
	 */
	public void setKaishibianhao(String kaishibianhao) {
		this.kaishibianhao = kaishibianhao;
	}
	/**
	 * 获取：开始编号
	 */
	public String getKaishibianhao() {
		return kaishibianhao;
	}
	/**
	 * 设置：项目名称
	 */
